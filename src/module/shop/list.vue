<template>
  <div class="online-shop w-full flex flex-col bg-white border-1 h-full border-gray-800 border border-solid rounded-t">
    ...
    <vue-scroll class="flex-1">
      <div
        class="online-shop_list"
        v-for="shop in shops"
        :key="shop.key"
        :style="{ minHeight: '90px', backgroundImage: `url('${shop.coverImg}')` }"
      >
        <div class="absolute inset-0 bg-gray-700 opacity-70 z-0" />

        <div
          class="online-shop_logo"
        >
          <img
        ...
        <div class="online-shop_actions flex flex-col items-end">
...
import { S3_SHOP_DOMAIN } from '@/.env';
      ...
      shops: [
        {
          ...
          logo: `${S3_SHOP_DOMAIN}/chaly-travel-tours/chaly-logo.jpg`,
          coverImg: `${S3_SHOP_DOMAIN}/chaly-travel-tours/chaly-cover.jpg`,
        ...
        },
        {
          ...
          name: 'Klassy',
          slogan: 'Since 1990',
          logo: `${S3_SHOP_DOMAIN}/klassy/klassy-logo.png`,
          coverImg: `${S3_SHOP_DOMAIN}/klassy/slide-01.jpg`,
          category: ['Convenience shop'],
          tags: ['tiyange', 'everyday needs', 'noodles']
        },
        {
          key: 'dough-deal-bcd', // must be unique
          name: 'Dough Deal Bcd',
          logo: `${S3_SHOP_DOMAIN}/dough-deal-bcd/dough-logo.jpg`,
          coverImg: `${S3_SHOP_DOMAIN}/dough-deal-bcd/dough-cover.jpg`,
          category: ['Convenience shop'],
          tags: ['tiyange', 'everyday needs', 'noodles']
        },
        {
          ...
          logo: `${S3_SHOP_DOMAIN}/cha-rose-bbq/cha-rose-logo.jpg`,
          coverImg: `${S3_SHOP_DOMAIN}/cha-rose-bbq/cha-rose-cover.jpg`,
        ...
        },
        {
          ...
          logo: `${S3_SHOP_DOMAIN}/pomato/logo.png`,
          coverImg: `${S3_SHOP_DOMAIN}/pomato/banner.jpg`,
          category: ['Barbeque', 'Food'],
          tags: ['tiyange', 'everyday needs', 'noodles']
        },
        {
          ...
          logo: `${S3_SHOP_DOMAIN}/lories-kitchenette/lorie-logo.jpg`,
          coverImg: `${S3_SHOP_DOMAIN}/lories-kitchenette/lorie-cover.jpg`,
          category: ['Barbeque', 'Food'],
          tags: ['tiyange', 'everyday needs', 'noodles']
        },
        {
